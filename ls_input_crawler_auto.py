...
for fn in fn_list_s:
    ...
    # Creating a new logger for each file
    logger = logging.getLogger(f'logger_{fn}')
    ...
    logger.debug("file currently running: %s" % in_path)
    ...
    while True:
        ...
        if not script_running:
            ...
            try:
                ...
                logger.debug("%s complete successfully!", fn)

            except Exception as e:
                logger.debug("Error restarting %s: %s", script_name, e)
